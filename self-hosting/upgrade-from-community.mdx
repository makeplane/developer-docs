...
<Warning> 
 ...
 The instructions provided on this page are specific to installations using Docker. If you are running Plane on Kubernetes, the backup process differs. You'll need to manually create a database dump and back up your file storage by copying the relevant volumes or storage paths.
</Warning>
