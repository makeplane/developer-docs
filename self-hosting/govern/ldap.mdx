...
- Plane Commercial Edition (Enterprise plan)
...
4. Click **Configure** next to **LDAP** at the bottom of the page. 
5. Enter your LDAP server details.
...
6. Click **Save changes** to apply your LDAP settings. Plane will validate the connection to your LDAP server.
