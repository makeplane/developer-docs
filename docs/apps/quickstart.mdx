...
1. [Register your Plane App](/guides/build-plane-app/#registering-your-app)
2. [Implement OAuth](/guides/build-plane-app#implement-oauth-flow)
3. [Obtain access tokens](/guides/build-plane-app#obtain-and-store-access-tokens-securely)
