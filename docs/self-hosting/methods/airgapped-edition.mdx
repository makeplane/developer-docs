...
:::warning
**IMPORTANT**
These instructions are for new installations only. If you're migrating from Community Edition to air-gapped, follow [this guide](/self-hosting/manage/upgrade/community-to-airgapped).
:::
