...
1. On a machine with internet access, pull the latest Plane images and push them to your air-gapped Docker registry. Follow the guide for [cloning and pushing Plane Docker images](/self-hosting/methods/clone-docker-images).
...
2. Download the latest Plane Enterprise Helm chart. You can check the most recent version on [Artifact Hub](https://artifacthub.io/packages/helm/makeplane/plane-enterprise).
   ...
   :::info
   Replace <chart_version> with the latest Helm chart version (e.g., %%HELM_EE_VERSION%%). You can check the most recent version on [Artifact Hub](https://artifacthub.io/packages/helm/makeplane/plane-enterprise).
   :::
