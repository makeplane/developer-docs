...
- `update-cli` — Downloads and installs the latest version of Prime CLI
  ...
  :::tip
  It is highly recommended to run `update-cli` before you download any Plane updates. The latest version of the CLI ensures your Plane upgrades happen smoothly.
  :::
...
The setup script `setup.sh` provides a menu-driven interface to help you install and manage your Plane Community Edition instance.
