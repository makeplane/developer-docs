...
Replace `<your domain name with http/https>` with your actual domain name,
...
If your server has a public IP address, configure a DNS A record to point your domain to this IP. This allows users to access your application using your custom domain. Steps:
