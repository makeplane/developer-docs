...
7. Create secrets in AWS Secrets Manager with your Plane configuration values (e.g., store RabbitMQ credentials as `prod/secrets/rabbitmq`).
   ...
   Repeat for all [environment variables](/self-hosting/methods/kubernetes#external-secrets-config) you want to manage in AWS Secrets Manager.
...
Set all [environment variables](/self-hosting/methods/kubernetes#external-secrets-config) in AWS Secrets Manager, then access them via ExternalSecret resources in your Kubernetes cluster.
...
3. Create a secret with your Plane configuration values (e.g., `secrets/rabbitmq_secrets`). For this example, we're setting up RabbitMQ credentials:
   ...
   Repeat for all [environment variables](/self-hosting/methods/kubernetes#external-secrets-config) you want to manage in Vault.
...
Repeat for all environment variables you want to manage in Vault, then access them via ExternalSecret resources in your Kubernetes cluster.
