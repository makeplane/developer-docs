...
4. Click on **Add new application** to begin the setup.
    ![Add GitLab application](/images/integrations/gitlab/add-gitlab-application.webp#center)
...
7. You can choose to check or leave the **Confidential** box unchecked—both options work for Plane.
    ...
    ![Add app details](/images/integrations/gitlab/add-app-details.webp#center)
...
1. Copy the **Application ID** and **Secret** from the newly created application.
    ![Copy credentials](/images/integrations/gitlab/copy-credentials.webp#center)
