...
2. Click **Create an App**.
    ![Create Slack App](/images/integrations/slack/create-slack-app.webp#center)

3. Choose **From a manifest**.
    ![Choose Manifest](/images/integrations/slack/choose-from-manifest.webp#center)
...
5. Remove the default manifest and paste the one below, making sure to update the placeholders with your actual values.
    ![Manifest](/images/integrations/slack/app-from-manifest.webp#center)
...
6. Review the permissions and click **Create**.
    ![Review summary](/images/integrations/slack/review-summary.webp#center)
...
2. Click **Retry** to verify your event subscription URL.
    ![Event subscriptions](/images/integrations/slack/event-subscriptions.webp#center)
