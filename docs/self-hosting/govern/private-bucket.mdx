...
:::note
New installations using the default storage (MinIO) do not need to change anything. For S3 or S3-compatible storage, see [this guide](https://developers.plane.so/self-hosting/govern/database-and-storage).
:::
