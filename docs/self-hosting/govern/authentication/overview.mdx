...
Your users can log in with passwords that they or you set for them. This is enabled
when SMTP isn't configured for your instance. Disable it if you would like to use
another authentication method below.
