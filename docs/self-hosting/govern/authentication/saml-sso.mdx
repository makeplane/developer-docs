...
:::tip
Depending on your IdP, you will have to find both the `Name ID format` and the three other user identification properties on different screens. Please refer to your IdP's documentation when configuring these. You may also need to configure the IdP to sign assertions. Regardless, copy the signing certificate from the IdP.
:::
