...
<ApiParam name="default_assignee" type="string" :required="false">
...
<ApiParam name="icon_prop" type="object" :required="false">
...
<ApiParam name="default_state" type="string" :required="false">
