---
title: Get a relation definition
description: Read a relation definition with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, get a relation definition, relation definitions, work item relation definitions retrieve
---
...
Relation definitions are the workspace registry of typed work item relationships. Read a single relation definition by id.
...
<CodePanel title="Get a relation definition" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
