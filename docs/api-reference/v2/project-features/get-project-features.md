...
description: Read a project feature with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, get project features, project features, project features retrieve
---
...
```json
{
  "type": "not_found",
  "code": "not_found",
  "detail": "No project feature matches the given query."
}
```
