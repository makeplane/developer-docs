---
title: Upsert a label
description: Upsert a label with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, upsert a label, labels, labels upsert
---
...
<div class="api-endpoint-badge">
  ...
  <span class="path">/api/v2/workspaces/{slug}/projects/{project_id}/labels/upsert/</span>
</div>

<div class="api-two-column">
<div class="api-left">

Labels are the project's tag catalog. Create a label, or update the existing one that carries the same `(external_source, external_id)` pair.
...
<CodePanel title="Upsert a label" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>

```bash
curl -X POST \
  "https://api.plane.so/api/v2/workspaces/my-team/projects/4af68566-94a4-4eb3-94aa-50dc9427067b/labels/upsert/" \
