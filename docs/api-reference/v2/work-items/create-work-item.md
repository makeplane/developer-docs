...
| Status | Code                         | Cause                                                                                                                                                                                                                             |
| ------ | ---------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `400`  | `validation_error`           | Missing `name`; a bad `priority`; `start_date` after `target_date`; an unresolvable or ambiguous `state`/`type`/`parent`/`assignees`/`labels`/`estimate`; both a name and its `*_id`; or an id from another project or workspace. |
| `401`  | `unauthorized`               | Missing or invalid credentials.                                                                                                                                                                                                   |
| `403`  | `forbidden`                  | Your role or token scope can't create work items in this project.                                                                                                                                                                 |
| `403`  | `workflow_transition_denied` | A workflow rule forbids creating a work item in the requested state.                                                                                                                                                              |
