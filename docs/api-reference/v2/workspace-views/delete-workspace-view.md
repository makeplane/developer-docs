---
title: Delete a workspace view
description: Delete a workspace view with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a workspace view, workspace views, workspace views destroy
---
...
<CodePanel title="Delete a workspace view" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
