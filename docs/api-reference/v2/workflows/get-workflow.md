...
description: Read a workflow with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, get a workflow, workflows, workflows retrieve
---
...
<CodePanel title="Get a workflow" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
