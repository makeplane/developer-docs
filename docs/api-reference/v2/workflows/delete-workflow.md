...
description: Delete a workflow with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a workflow, workflows, workflows destroy
---
...
<CodePanel title="Delete a workflow" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
