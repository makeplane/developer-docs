...
description: Update a project view with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, update a project view, project views, project views partial update
---
...
<div class="api-endpoint-badge">
  ...
  <span class="path">/api/v2/workspaces/{slug}/projects/{project_id}/views/{pk}/</span>
</div>
...
<CodePanel title="Update a project view" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>

```bash
curl -X PATCH \
  "https://api.plane.so/api/v2/workspaces/my-team/projects/4af68566-94a4-4eb3-94aa-50dc9427067b/views/9c1f0b3d-6d2e-4c9a-8b41-2f7e5a0d6c88/" \
...
```json
{
  "type": "not_found",
  "code": "not_found",
  "detail": "No project view matches the given query."
}
```
