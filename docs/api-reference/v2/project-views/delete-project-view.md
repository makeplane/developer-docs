---
title: Delete a project view
description: Delete a project view with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a project view, project views, project views destroy
---
...
<CodePanel title="Delete a project view" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
