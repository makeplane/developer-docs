...
description: List project views with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, list project views, project views, project views list
---
...
<CodePanel title="List project views" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
