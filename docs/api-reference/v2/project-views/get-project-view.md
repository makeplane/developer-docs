...
description: Read a project view with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, get a project view, project views, project views retrieve
---
...
<CodePanel title="Get a project view" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
