...
description: Update a project with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, update a project, projects, projects partial update
---
...
<ApiParam name="archive_in" type="integer" :required="false">

The archive in.

</ApiParam>

<ApiParam name="close_in" type="integer" :required="false">

The close in.

</ApiParam>

<ApiParam name="cover_image" type="string" :required="false">
...
<ApiParam name="cycle_view" type="boolean" :required="false">

Whether cycle view.

</ApiParam>

<ApiParam name="default_assignee_id" type="string (uuid)" :required="false">

Id of the related default assignee.

Nullable.

</ApiParam>

<ApiParam name="default_state_id" type="string (uuid)" :required="false">

Id of the related default state.
...
<ApiParam name="emoji" type="string" :required="false">
...
<ApiParam name="estimate_id" type="string (uuid)" :required="false">
...
<ApiParam name="guest_view_all_features" type="boolean" :required="false">

Whether guest view all features.

</ApiParam>

<ApiParam name="icon_prop" type="string" :required="false">
...
<ApiParam name="intake_view" type="boolean" :required="false">

Whether intake view.

</ApiParam>

<ApiParam name="is_issue_type_enabled" type="boolean" :required="false">

Whether is issue type enabled.

</ApiParam>

<ApiParam name="is_time_tracking_enabled" type="boolean" :required="false">

Whether is time tracking enabled.

</ApiParam>

<ApiParam name="issue_views_view" type="boolean" :required="false">
...
<ApiParam name="module_view" type="boolean" :required="false">
...
<ApiParam name="network" type="string" :required="false">

Project visibility: `0` is private to members, `2` is visible to the whole workspace.

</ApiParam>

<ApiParam name="page_view" type="boolean" :required="false">
...
<ApiParam name="project_lead_id" type="string (uuid)" :required="false">

Id of the related project lead.
...
<ApiParam name="target_date" type="string (date-time)" :required="false">
