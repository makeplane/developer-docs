---
title: Delete a project work item template
description: Delete a project work item template with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a project work item template, project work item templates, project work item templates destroy
---

# Delete a project work item template
...
<CodePanel title="Delete a project work item template" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
