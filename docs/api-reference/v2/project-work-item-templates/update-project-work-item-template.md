---
title: Update a project work item template
description: Update a project work item template with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, update a project work item template, project work item templates, project work item templates partial update
---

# Update a project work item template
...
<CodePanel title="Update a project work item template" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
