---
title: Upsert a module
description: Upsert a module with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, upsert a module, modules, modules upsert
---
...
<div class="api-endpoint-badge">
  ...
  <span class="path">/api/v2/workspaces/{slug}/projects/{project_id}/modules/upsert/</span>
</div>

<div class="api-two-column">
<div class="api-left">

Modules group work items into a deliverable inside a project. Create a module, or update the existing one that carries the same `(external_source, external_id)` pair.
...
Comma-separated relations to embed: `lead`, `members`.
...
<CodePanel title="Upsert a module" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>

```bash
curl -X POST \
  "https://api.plane.so/api/v2/workspaces/my-team/projects/4af68566-94a4-4eb3-94aa-50dc9427067b/modules/upsert/" \
