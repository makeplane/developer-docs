...
description: List workflow states with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, list workflow states, workflow states, workflow states list
---
...
<CodePanel title="List workflow states" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
