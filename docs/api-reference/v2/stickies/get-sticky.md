---
title: Get a sticky
description: Read a sticky with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, get a sticky, stickies, stickies retrieve
---
...
<CodePanel title="Get a sticky" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
