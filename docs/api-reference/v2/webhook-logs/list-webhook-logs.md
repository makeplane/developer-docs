...
description: List webhook logs with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, list webhook logs, webhook logs, webhook logs list
---
...
<div class="api-endpoint-badge">
  ...
  <span class="path">/api/v2/workspaces/{slug}/webhook-logs/{webhook_id}/</span>
</div>
...
<CodePanel title="List webhook logs" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>

```bash
curl -X GET \
  "https://api.plane.so/api/v2/workspaces/my-team/webhook-logs/9c1f0b3d-6d2e-4c9a-8b41-2f7e5a0d6c88/" \
