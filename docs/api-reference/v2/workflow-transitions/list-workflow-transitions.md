...
description: List workflow transitions with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, list workflow transitions, workflow transitions, workflow transitions list
---
...
<CodePanel title="List workflow transitions" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
