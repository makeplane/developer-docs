---
title: Get a workflow transition
description: Read a workflow transition with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, get a workflow transition, workflow transitions, workflow transitions retrieve
---
...
<CodePanel title="Get a workflow transition" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
