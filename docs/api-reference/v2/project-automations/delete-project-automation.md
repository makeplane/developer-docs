---
title: Delete a project automation
description: Delete a project automation with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a project automation, project automations, project automations destroy
---

# Delete a project automation
...
<CodePanel title="Delete a project automation" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
