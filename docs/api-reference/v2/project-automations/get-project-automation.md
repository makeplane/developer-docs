---
title: Get a project automation
description: Read a project automation with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, get a project automation, project automations, project automations retrieve
---

# Get a project automation
...
<CodePanel title="Get a project automation" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
