---
title: Create a project automation
description: Create a project automation with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, create a project automation, project automations, project automations create
---
...
<div class="api-endpoint-badge">
  ...
  <span class="path">/api/v2/workspaces/{slug}/projects/{project_id}/automations/</span>
</div>
...
<ApiParam name="scope" type="string" :required="true">
...
<CodePanel title="Create a project automation" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
