---
title: List project automations
description: List project automations with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, list project automations, project automations, project automations list
---
...
<CodePanel title="List project automations" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
