---
title: List automation edges
description: List automation edges with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, list automation edges, automation edges, project automation edges list
---
...
<CodePanel title="List automation edges" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
