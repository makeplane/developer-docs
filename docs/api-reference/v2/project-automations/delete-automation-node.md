---
title: Delete a automation node
description: Delete a automation node with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a automation node, automation nodes, project automation nodes destroy
---

# Delete a automation node
...
<CodePanel title="Delete a automation node" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
