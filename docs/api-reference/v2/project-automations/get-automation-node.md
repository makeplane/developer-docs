---
title: Get a automation node
description: Read a automation node with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, get a automation node, automation nodes, project automation nodes retrieve
---

# Get a automation node
...
<CodePanel title="Get a automation node" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
