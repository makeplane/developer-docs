...
description: Read a project page with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, get a project page, project pages, project pages retrieve
---
...
<CodePanel title="Get a project page" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
