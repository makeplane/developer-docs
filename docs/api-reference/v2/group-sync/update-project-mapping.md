---
title: Update a project mapping
description: Update a project mapping with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, update a project mapping, project mappings, group sync project mappings update
---
...
<CodePanel title="Update a project mapping" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
