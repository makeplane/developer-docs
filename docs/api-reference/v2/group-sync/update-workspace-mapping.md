---
title: Update a workspace mapping
description: Update a workspace mapping with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, update a workspace mapping, workspace mappings, group sync workspace mappings update
---

# Update a workspace mapping
...
<ApiParam name="role_slug" type="string" :required="false">
...
<CodePanel title="Update a workspace mapping" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
