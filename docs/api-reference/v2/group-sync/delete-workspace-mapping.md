---
title: Delete a workspace mapping
description: Delete a workspace mapping with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a workspace mapping, workspace mappings, group sync workspace mappings destroy
---
...
<CodePanel title="Delete a workspace mapping" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
