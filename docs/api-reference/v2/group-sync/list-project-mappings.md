---
title: List project mappings
description: List project mappings with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, list project mappings, project mappings, group sync project mappings list
---
...
<CodePanel title="List project mappings" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
...
```javascript
const response = await fetch("https://api.plane.so/api/v2/workspaces/my-team/group-sync/project-mappings/", {
  method: "GET",
  headers: {
