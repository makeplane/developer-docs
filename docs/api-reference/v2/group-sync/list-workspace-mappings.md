---
title: List workspace mappings
description: List workspace mappings with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, list workspace mappings, workspace mappings, group sync workspace mappings list
---
...
<CodePanel title="List workspace mappings" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
