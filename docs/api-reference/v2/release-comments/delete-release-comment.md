---
title: Delete a release comment
description: Delete a release comment with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a release comment, release comments, release comments destroy
---
...
<CodePanel title="Delete a release comment" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
