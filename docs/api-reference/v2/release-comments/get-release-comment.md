---
title: Get a release comment
description: Read a release comment with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, get a release comment, release comments, release comments retrieve
---

# Get a release comment
...
<CodePanel title="Get a release comment" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
