---
title: List workspace work item templates
description: List workspace work item templates with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, list workspace work item templates, workspace work item templates, workspace work item templates list
---
...
<CodePanel title="List workspace work item templates" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
