---
title: Get a worklog
description: Read a worklog with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, get a worklog, worklogs, worklogs retrieve
---
...
<CodePanel title="Get a worklog" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
