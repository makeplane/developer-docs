---
title: Get a attachment
description: Read a attachment with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, get a attachment, attachments, attachments retrieve
---
...
<CodePanel title="Get a attachment" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
