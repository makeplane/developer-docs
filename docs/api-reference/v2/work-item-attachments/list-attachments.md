...
description: List attachments with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, list attachments, attachments, attachments list
---
...
<CodePanel title="List attachments" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
