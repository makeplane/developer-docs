---
title: Create a work item attachment upload
description: Create a attachment with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, create a work item attachment upload, attachments, attachments create
---
...
<div class="api-endpoint-badge">
  ...
  <span class="path">/api/v2/workspaces/{slug}/projects/{project_id}/work-items/{work_item_id}/attachments/</span>
</div>
...
<CodePanel title="Create a work item attachment upload" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
