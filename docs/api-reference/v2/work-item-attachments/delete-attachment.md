...
description: Delete a attachment with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a attachment, attachments, attachments destroy
---
...
<CodePanel title="Delete a attachment" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
