...
description: Delete a release with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a release, releases, releases destroy
---
...
<CodePanel title="Delete a release" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
