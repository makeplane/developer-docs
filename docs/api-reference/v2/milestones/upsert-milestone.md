---
title: Upsert a milestone
description: Upsert a milestone with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, upsert a milestone, milestones, milestones upsert
---
...
<div class="api-endpoint-badge">
  ...
  <span class="path">/api/v2/workspaces/{slug}/projects/{project_id}/milestones/upsert/</span>
</div>

<div class="api-two-column">
<div class="api-left">

Milestones mark dated checkpoints in a project. Create a milestone, or update the existing one that carries the same `(external_source, external_id)` pair.
...
Requestable here: `archived_at`, `created_at`, `created_by_id`, `external_id`, `external_source`, `id`, `target_date`, `title`.
...
<CodePanel title="Upsert a milestone" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>

```bash
curl -X POST \
  "https://api.plane.so/api/v2/workspaces/my-team/projects/4af68566-94a4-4eb3-94aa-50dc9427067b/milestones/upsert/" \
