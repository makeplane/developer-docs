...
description: Delete a customer request with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a customer request, customer requests, customer requests destroy
---
