...
description: Update a customer request with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, update a customer request, customer requests, customer requests partial update
---
...
<ApiParam name="work_item_ids" type="array of string (uuid)" :required="false">
