---
title: Delete a estimate point
description: Delete a estimate point with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a estimate point, estimate points, estimate points destroy
---

# Delete a estimate point
...
<CodePanel title="Delete a estimate point" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
