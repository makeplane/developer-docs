---
title: Get a estimate point
description: Read a estimate point with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, get a estimate point, estimate points, estimate points retrieve
---

# Get a estimate point
...
<CodePanel title="Get a estimate point" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
