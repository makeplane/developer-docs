---
title: Update a link
description: Update a link with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, update a link, links, links partial update
---
