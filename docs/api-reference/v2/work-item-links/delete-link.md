---
title: Delete a link
description: Delete a link with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a link, links, links destroy
---
