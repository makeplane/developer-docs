...
description: Delete a teamspace with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a teamspace, teamspaces, teamspaces destroy
---
