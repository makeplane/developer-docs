...
description: Create a estimate with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, create a estimate, estimates, estimates create
---
...
<CodePanel title="Create a estimate" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
