---
title: Delete a estimate
description: Delete a estimate with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a estimate, estimates, estimates destroy
---
...
<CodePanel title="Delete a estimate" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
