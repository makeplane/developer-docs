---
title: Delete a intake work item
description: Delete a intake work item with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a intake work item, intake work items, intakes destroy
---

# Delete a intake work item
...
<CodePanel title="Delete a intake work item" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
