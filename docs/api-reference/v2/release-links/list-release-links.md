...
description: List release links with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, list release links, release links, release links list
---
...
<CodePanel title="List release links" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
