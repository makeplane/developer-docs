---
title: Delete a workspace automation
description: Delete a workspace automation with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a workspace automation, workspace automations, workspace automations destroy
---
...
<CodePanel title="Delete a workspace automation" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
