---
title: Update a workspace automation
description: Update a workspace automation with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, update a workspace automation, workspace automations, workspace automations partial update
---

# Update a workspace automation
...
<CodePanel title="Update a workspace automation" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
