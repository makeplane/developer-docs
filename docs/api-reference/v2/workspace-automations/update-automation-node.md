...
keywords: plane api v2, update a automation node, automation nodes, workspace automation nodes partial update
---
...
<div class="api-endpoint-badge">
  ...
  <span class="path">/api/v2/workspaces/{slug}/automations/{automation_id}/nodes/{pk}/</span>
</div>
...
```bash
curl -X PATCH \
  "https://api.plane.so/api/v2/workspaces/my-team/automations/9c1f0b3d-6d2e-4c9a-8b41-2f7e5a0d6c88/nodes/8f4c2b1e-0d3a-4f7b-9c21-6e5a8b7d4f13/" \
