---
title: Update a initiative
description: Update a initiative with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, update a initiative, initiatives, initiatives partial update
---
...
<div class="api-endpoint-badge">
  ...
  <span class="path">/api/v2/workspaces/{slug}/initiatives/{pk}/</span>
</div>
...
One of `DRAFT`, `PLANNED`, `ACTIVE`, `COMPLETED`, `CLOSED`.
...
Requestable here: `archived_at`, `created_at`, `created_by_id`, `description`, `description_html`, `end_date`, `id`, `label_ids`, `lead_id`, `logo_props`, `name`, `project_ids`, `start_date`, `state`.
...
<CodePanel title="Update a initiative" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>

```bash
curl -X PATCH \
  "https://api.plane.so/api/v2/workspaces/my-team/initiatives/9c1f0b3d-6d2e-4c9a-8b41-2f7e5a0d6c88/" \
...
```json
{
  "type": "not_found",
  "code": "not_found",
  "detail": "No initiative matches the given query."
}
```
