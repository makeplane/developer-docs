---
title: Delete a initiative
description: Delete a initiative with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a initiative, initiatives, initiatives destroy
---
...
<CodePanel title="Delete a initiative" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
