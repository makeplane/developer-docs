---
title: Get a initiative
description: Read a initiative with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, get a initiative, initiatives, initiatives retrieve
---
...
<CodePanel title="Get a initiative" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
