---
title: Update a release label
description: Update a release label with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, update a release label, release labels, release labels partial update
---
...
<ApiParam name="sort_order" type="integer" :required="false">
...
<CodePanel title="Update a release label" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
