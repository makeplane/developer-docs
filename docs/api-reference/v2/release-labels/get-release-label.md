---
title: Get a release label
description: Read a release label with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, get a release label, release labels, release labels retrieve
---
...
<CodePanel title="Get a release label" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
