---
title: Delete a user asset
description: Delete a user asset with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a user asset, user assets, user assets destroy
---
...
<CodePanel title="Delete a user asset" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
...
```javascript
const response = await fetch("https://api.plane.so/api/v2/users/me/assets/9c1f0b3d-6d2e-4c9a-8b41-2f7e5a0d6c88/", {
  method: "DELETE",
  headers: {
