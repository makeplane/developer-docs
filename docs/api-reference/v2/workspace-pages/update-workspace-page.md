...
description: Update a workspace page with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, update a workspace page, workspace pages, workspace pages partial update
---
