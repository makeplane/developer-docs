---
title: Get a customer property
description: Read a customer property with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, get a customer property, customer properties, customer properties retrieve
---
...
<CodePanel title="Get a customer property" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
