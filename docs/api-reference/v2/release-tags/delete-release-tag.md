---
title: Delete a release tag
description: Delete a release tag with the Plane v2 REST API. Parameters, sparse `?fields=` responses, OAuth scopes, error codes, and code examples.
keywords: plane api v2, delete a release tag, release tags, release tags destroy
---
...
<CodePanel title="Delete a release tag" :languages="['cURL', 'Python', 'JavaScript']">
<template #curl>
