...
<div class="api-endpoint-badge">
  ...
  <span class="path">/api/v1/workspaces/{workspace_slug}/projects/{project_id}/work-items/{work_item_id}/activities/{resource_id}/</span>
</div>
...
```javascript
const response = await fetch("https://api.plane.so/api/v1/workspaces/my-workspace/projects/project-uuid/work-items/work-item-uuid/activities/resource-id-uuid/?cursor=20:1:0&expand=assignees", {
  method: "GET",
  headers: {
