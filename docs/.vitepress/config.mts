          ...
          "/": [
            ...
            },
            {
              ...
              items: [
                ...
                { text: "Choose your install", link: "/self-hosting/methods/overview" },
                { text: "Docker Compose", link: "/self-hosting/methods/docker-compose" },
                { text: "Kubernetes", link: "/self-hosting/methods/kubernetes" },
                { text: "Airgapped Edition", link: "/self-hosting/methods/airgapped-requirements" },
              ],
            },
            {
              text: "API Reference",
          ...
          "/self-hosting/": [
            {
              ...
              items: [
                ...
                { text: "Versions and releases", link: "/self-hosting/versions" },
            ...
            },
            {
              ...
              items: [
                { text: "Choose your install", link: "/self-hosting/methods/overview" },
                { text: "Before you install", link: "/self-hosting/methods/prerequisites" },
                { text: "Docker Compose", link: "/self-hosting/methods/docker-compose" },
                {
                  text: "Kubernetes",
                  ...
                  collapsed: true,
                  items: [
                    { text: "Helm values reference", link: "/self-hosting/methods/kubernetes-values" },
                ...
                },
                {
                  ...
                  collapsed: false,
                  items: [
                    { text: "Overview and requirements", link: "/self-hosting/methods/airgapped-requirements" },
                ...
                { text: "After you install", link: "/self-hosting/methods/after-install" },
                {
                  text: "Community Edition",
                  collapsed: true,
                  items: [
                    { text: "Overview", link: "/self-hosting/community/overview" },
                    { text: "Docker Compose", link: "/self-hosting/community/docker-compose" },
                    { text: "Kubernetes", link: "/self-hosting/community/kubernetes" },
                    { text: "Manage your instance", link: "/self-hosting/community/manage" },
                  ],
                },
              ],
            },
            ...
            },
            {
              ...
              items: [
                ...
                { text: "Manage users", link: "/self-hosting/manage/manage-instance-users" },
                {
                  ...
                  collapsed: true,
                  items: [
                    { text: "Community to Commercial Edition", link: "/self-hosting/upgrade-from-community" },
                    { text: "Community to Airgapped Edition", link: "/self-hosting/manage/community-to-airgapped" },
                    { text: "Move to another server", link: "/self-hosting/manage/migrate-plane" },
                    {
                      text: "Move data to external services",
