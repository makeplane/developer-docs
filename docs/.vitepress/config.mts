              ...
              items: [
                { text: "Introduction", link: "/api-reference/v1/introduction" },
                {
                  ...
                  items: [
                    ...
                    { text: "Update Project", link: "/api-reference/v1/project/update-project-detail" },
                    { text: "Archive Project", link: "/api-reference/v1/project/archive-project" },
                    { text: "Unarchive Project", link: "/api-reference/v1/project/unarchive-project" },
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { text: "Get Project Features", link: "/api-reference/v1/project-features/get-project-features" },
                    {
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { text: "Create Project Label", link: "/api-reference/v1/project-labels/add-project-label" },
                    { text: "List Project Labels", link: "/api-reference/v1/project-labels/list-project-labels" },
                    {
                    ...
                    { text: "Delete Project Label", link: "/api-reference/v1/project-labels/delete-project-label" },
                  ],
                },
                {
                  text: "Work Item",
                  ...
                  items: [
                    ...
                    { text: "Get by identifier", link: "/api-reference/v1/issue/get-issue-sequence-id" },
                    { text: "Search Work Items", link: "/api-reference/v1/issue/search-issues" },
                    { text: "Advanced Search", link: "/api-reference/v1/issue/advanced-search-work-items" },
                    { text: "Update Work Item", link: "/api-reference/v1/issue/update-issue-detail" },
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { text: "Add Type", link: "/api-reference/v1/issue-types/types/add-issue-type" },
                    { text: "List Types", link: "/api-reference/v1/issue-types/types/list-issue-types" },
                    { text: "Get Type Details", link: "/api-reference/v1/issue-types/types/get-issue-type-details" },
                    { text: "Get Type Schema", link: "/api-reference/v1/issue-types/types/get-work-item-type-schema" },
                    { text: "Update Type", link: "/api-reference/v1/issue-types/types/update-issue-types" },
                    { text: "Delete Type", link: "/api-reference/v1/issue-types/types/delete-issue-type" },
                  ],
                },
                {
                  ...
                  items: [
                    ...
                    { text: "Add Property", link: "/api-reference/v1/issue-types/properties/add-property" },
                    { text: "List Properties", link: "/api-reference/v1/issue-types/properties/list-properties" },
                    {
                      text: "Get Property Details",
                      link: "/api-reference/v1/issue-types/properties/get-property-details",
                    },
                    { text: "Update Property", link: "/api-reference/v1/issue-types/properties/update-property" },
                    { text: "Delete Property", link: "/api-reference/v1/issue-types/properties/delete-property" },
                  ],
                },
                {
                  ...
                  items: [
                    ...
                    { text: "Add Property Values", link: "/api-reference/v1/issue-types/values/add-property-values" },
                    { text: "List Property Values", link: "/api-reference/v1/issue-types/values/list-property-values" },
                    {
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { text: "Get Option Details", link: "/api-reference/v1/issue-types/options/get-option-details" },
                    {
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { text: "List Activities", link: "/api-reference/v1/issue-activity/list-issue-activities" },
                    { text: "Get Activity", link: "/api-reference/v1/issue-activity/get-issue-activity-detail" },
                  ],
                },
                {
                  ...
                  items: [
                    ...
                    { text: "Add Comment", link: "/api-reference/v1/issue-comment/add-issue-comment" },
                    { text: "List Comments", link: "/api-reference/v1/issue-comment/list-issue-comments" },
                    { text: "Get Comment", link: "/api-reference/v1/issue-comment/get-issue-comment-detail" },
                    { text: "Update Comment", link: "/api-reference/v1/issue-comment/update-issue-comment-detail" },
                    { text: "Delete Comment", link: "/api-reference/v1/issue-comment/delete-issue-comment" },
                  ],
                },
                {
                  ...
                  items: [
                    ...
                    { text: "Get Attachments", link: "/api-reference/v1/issue-attachments/get-attachments" },
                    {
                    ...
                    { text: "Upload File", link: "/api-reference/v1/issue-attachments/upload-file" },
                    { text: "Complete Upload", link: "/api-reference/v1/issue-attachments/complete-upload" },
                    { text: "Update Attachment", link: "/api-reference/v1/issue-attachments/update-attachment" },
                    { text: "Delete Attachment", link: "/api-reference/v1/issue-attachments/delete-attachment" },
                  ],
                },
                {
                  ...
                  items: [
                    ...
                    { text: "List Work Item Pages", link: "/api-reference/v1/work-item-pages/list-work-item-pages" },
                    {
...

                {
                  ...
                  items: [
                    ...
                    { text: "Add Work Items", link: "/api-reference/v1/cycle/add-cycle-work-items" },
                    { text: "Transfer Work Items", link: "/api-reference/v1/cycle/transfer-cycle-work-items" },
                    ...
                    { text: "List Cycle Work Items", link: "/api-reference/v1/cycle/list-cycle-work-items" },
                    { text: "List Archived Cycles", link: "/api-reference/v1/cycle/list-archived-cycles" },
                    ...
                    { text: "Remove Work Item", link: "/api-reference/v1/cycle/remove-cycle-work-item" },
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { text: "Add Work Items", link: "/api-reference/v1/module/add-module-work-items" },
                    ...
                    { text: "List Module Work Items", link: "/api-reference/v1/module/list-module-work-items" },
                    { text: "List Archived Modules", link: "/api-reference/v1/module/list-archived-modules" },
                    { text: "Update Module", link: "/api-reference/v1/module/update-module-detail" },
                    { text: "Unarchive Module", link: "/api-reference/v1/module/unarchive-module" },
                    { text: "Remove Work Item", link: "/api-reference/v1/module/remove-module-work-item" },
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { text: "List Workspace Pages", link: "/api-reference/v1/page/list-workspace-pages" },
                    { text: "Add Workspace Page", link: "/api-reference/v1/page/add-workspace-page" },
                    { text: "List Project Pages", link: "/api-reference/v1/page/list-project-pages" },
                    { text: "Add Project Page", link: "/api-reference/v1/page/add-project-page" },
                    { text: "Get Workspace Page", link: "/api-reference/v1/page/get-workspace-page" },
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { text: "Add Intake Issue", link: "/api-reference/v1/intake-issue/add-intake-issue" },
                    { text: "List Intake Issues", link: "/api-reference/v1/intake-issue/list-intake-issues" },
                    { text: "Get Intake Issue", link: "/api-reference/v1/intake-issue/get-intake-issue-detail" },
                    { text: "Update Intake Issue", link: "/api-reference/v1/intake-issue/update-intake-issue-detail" },
                    { text: "Delete Intake Issue", link: "/api-reference/v1/intake-issue/delete-intake-issue" },
                  ],
                },
                {
                  text: "Assets",
                  ...
                  items: [
                    ...
                    { text: "Create User Asset Upload", link: "/api-reference/v1/assets/create-user-asset-upload" },
                    { text: "Update User Asset", link: "/api-reference/v1/assets/update-user-asset" },
                    { text: "Delete User Asset", link: "/api-reference/v1/assets/delete-user-asset" },
                    {
                      text: "Create Workspace Asset Upload",
                      link: "/api-reference/v1/assets/create-workspace-asset-upload",
                    },
                    { text: "Get Workspace Asset", link: "/api-reference/v1/assets/get-workspace-asset" },
                    { text: "Update Workspace Asset", link: "/api-reference/v1/assets/update-workspace-asset" },
                  ],
                },
                {
                  text: "Milestones",
                  ...
                  items: [
                    ...
                    { text: "Create Milestone", link: "/api-reference/v1/milestones/add-milestone" },
                    { text: "List Milestones", link: "/api-reference/v1/milestones/list-milestones" },
                    { text: "Get Milestone", link: "/api-reference/v1/milestones/get-milestone-detail" },
                    {
                      text: "List Milestone Work Items",
                      link: "/api-reference/v1/milestones/list-milestone-work-items",
                    },
                    { text: "Update Milestone", link: "/api-reference/v1/milestones/update-milestone-detail" },
                    { text: "Delete Milestone", link: "/api-reference/v1/milestones/delete-milestone" },
                  ],
                },
                {
                  text: "Estimates",
                  ...
                  items: [
                    ...
                    { text: "List Estimate Points", link: "/api-reference/v1/estimate/list-estimate-points" },
                    { text: "Create Estimate Points", link: "/api-reference/v1/estimate/add-estimate-points" },
                    { text: "Update Estimate Point", link: "/api-reference/v1/estimate/update-estimate-point" },
                    { text: "Delete Estimate Point", link: "/api-reference/v1/estimate/delete-estimate-point" },
                  ],
                },
                {
                  text: "Time Tracking",
                  ...
                  items: [
                    ...
                    { text: "Get Worklogs for Issue", link: "/api-reference/v1/worklogs/get-worklogs-for-issue" },
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { text: "Add Epic Work Items", link: "/api-reference/v1/epics/add-epic-work-items" },
                    { text: "List Epic Work Items", link: "/api-reference/v1/epics/list-epic-work-items" },
                  ],
                },
                {
                  text: "Initiatives",
                  ...
                  items: [
                    ...
                    { text: "Create Initiative", link: "/api-reference/v1/initiative/add-initiative" },
                    { text: "List Initiatives", link: "/api-reference/v1/initiative/list-initiatives" },
                    { text: "Get Initiative", link: "/api-reference/v1/initiative/get-initiative-detail" },
                    { text: "Update Initiative", link: "/api-reference/v1/initiative/update-initiative-detail" },
                    { text: "Delete Initiative", link: "/api-reference/v1/initiative/delete-initiative" },
                  ],
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    { text: "Add Label", link: "/api-reference/v1/initiative/add-initiative-label" },
                    { text: "Add Labels to Initiative", link: "/api-reference/v1/initiative/add-labels-to-initiative" },
                    { text: "List Initiative Labels", link: "/api-reference/v1/initiative/list-initiative-labels" },
                    { text: "Get Label Detail", link: "/api-reference/v1/initiative/get-initiative-label-detail" },
                    {
                      text: "List Labels for Initiative",
                      link: "/api-reference/v1/initiative/list-initiative-labels-for-initiative",
                    },
                    { text: "Update Label", link: "/api-reference/v1/initiative/update-initiative-label-detail" },
                    { text: "Remove Labels", link: "/api-reference/v1/initiative/remove-labels-from-initiative" },
                    { text: "Delete Label", link: "/api-reference/v1/initiative/delete-initiative-label" },
                  ],
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    { text: "Add Projects", link: "/api-reference/v1/initiative/add-projects-to-initiative" },
                    { text: "List Projects", link: "/api-reference/v1/initiative/list-initiative-projects" },
                    { text: "Remove Projects", link: "/api-reference/v1/initiative/remove-projects-from-initiative" },
                  ],
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    { text: "Add Epics", link: "/api-reference/v1/initiative/add-epics-to-initiative" },
                    { text: "List Epics", link: "/api-reference/v1/initiative/list-initiative-epics" },
                    { text: "Remove Epics", link: "/api-reference/v1/initiative/remove-epics-from-initiative" },
                  ],
                },
                {
                  text: "Customers",
                  ...
                  items: [
                    ...
                    { text: "Link Work Items", link: "/api-reference/v1/customer/link-work-items-to-customer" },
                    { text: "List Customers", link: "/api-reference/v1/customer/list-customers" },
                    { text: "Get Customer", link: "/api-reference/v1/customer/get-customer-detail" },
                    { text: "List Customer Work Items", link: "/api-reference/v1/customer/list-customer-work-items" },
                    { text: "Update Customer", link: "/api-reference/v1/customer/update-customer-detail" },
                    { text: "Unlink Work Item", link: "/api-reference/v1/customer/unlink-work-item-from-customer" },
                ...
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    { text: "Add Property", link: "/api-reference/v1/customer/add-customer-property" },
                    { text: "List Properties", link: "/api-reference/v1/customer/list-customer-properties" },
                    { text: "Get Property Detail", link: "/api-reference/v1/customer/get-customer-property-detail" },
                    { text: "List Property Values", link: "/api-reference/v1/customer/list-customer-property-values" },
                    { text: "Get Property Value", link: "/api-reference/v1/customer/get-customer-property-value" },
                    { text: "Update Property", link: "/api-reference/v1/customer/update-customer-property-detail" },
                    {
                      text: "Update Property Value",
                      link: "/api-reference/v1/customer/update-customer-property-value",
                    },
                    { text: "Delete Property", link: "/api-reference/v1/customer/delete-customer-property" },
                  ],
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    { text: "Add Request", link: "/api-reference/v1/customer/add-customer-request" },
                    { text: "List Requests", link: "/api-reference/v1/customer/list-customer-requests" },
                    { text: "Get Request Detail", link: "/api-reference/v1/customer/get-customer-request-detail" },
                    { text: "Update Request", link: "/api-reference/v1/customer/update-customer-request-detail" },
                    { text: "Delete Request", link: "/api-reference/v1/customer/delete-customer-request" },
                  ],
                },
                {
                  text: "Teamspaces",
                  ...
                  items: [
                    ...
                    { text: "List Teamspaces", link: "/api-reference/v1/teamspace/list-teamspaces" },
                    { text: "Get Teamspace", link: "/api-reference/v1/teamspace/get-teamspace-detail" },
                    { text: "Update Teamspace", link: "/api-reference/v1/teamspace/update-teamspace-detail" },
                    { text: "Delete Teamspace", link: "/api-reference/v1/teamspace/delete-teamspace" },
                  ],
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    { text: "List Members", link: "/api-reference/v1/teamspace/list-teamspace-members" },
                    { text: "Add Members", link: "/api-reference/v1/teamspace/add-teamspace-members" },
                    { text: "Remove Members", link: "/api-reference/v1/teamspace/remove-teamspace-members" },
                  ],
                },
                {
                  ...
                  collapsed: true,
                  items: [
                    { text: "List Projects", link: "/api-reference/v1/teamspace/list-teamspace-projects" },
                    { text: "Add Projects", link: "/api-reference/v1/teamspace/add-projects-to-teamspace" },
                    { text: "Remove Projects", link: "/api-reference/v1/teamspace/remove-projects-from-teamspace" },
                  ],
                },
                {
                  text: "Stickies",
                  ...
                  items: [
                    ...
                    { text: "Update Sticky", link: "/api-reference/v1/sticky/update-sticky-detail" },
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { text: "Get Workspace Members", link: "/api-reference/v1/members/get-workspace-members" },
                    { text: "Get Project Members", link: "/api-reference/v1/members/get-project-members" },
                    { text: "Create Project Member", link: "/api-reference/v1/members/add-project-member" },
                    { text: "Get Project Member", link: "/api-reference/v1/members/get-project-member-detail" },
                    { text: "Update Project Member", link: "/api-reference/v1/members/update-project-member" },
                    { text: "Delete Project Member", link: "/api-reference/v1/members/delete-project-member" },
                    { text: "Remove Workspace Members", link: "/api-reference/v1/members/remove-workspace-member" },
                  ],
                },
                {
                  text: "User",
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { text: "Get Group Sync Config", link: "/api-reference/v1/idp-group-sync/get-group-sync-config" },
                    {
                      text: "Update Group Sync Config",
                      link: "/api-reference/v1/idp-group-sync/update-group-sync-config",
                    },
                    { text: "List Project Mappings", link: "/api-reference/v1/idp-group-sync/list-project-mappings" },
                    { text: "Create Project Mapping", link: "/api-reference/v1/idp-group-sync/create-project-mapping" },
                    { text: "Get Project Mapping", link: "/api-reference/v1/idp-group-sync/get-project-mapping" },
                    { text: "Update Project Mapping", link: "/api-reference/v1/idp-group-sync/update-project-mapping" },
                    { text: "Delete Project Mapping", link: "/api-reference/v1/idp-group-sync/delete-project-mapping" },
                    {
