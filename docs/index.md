...
<div class="home-hero-text">Build, deploy, and integrate</div>

<p class="home-hero-tagline">Everything you need to self-host Plane, integrate with the REST API, and build powerful custom workflows.</p>
