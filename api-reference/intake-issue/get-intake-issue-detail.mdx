...
description: Retrieves the details of an existing intake work item by its ID.
api: GET /api/v1/workspaces/{workspace_slug}/projects/{project_id}/intake-issues/{issue_id}
---
