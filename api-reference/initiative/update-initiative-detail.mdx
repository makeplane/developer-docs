...
description: Updates an existing initiative by setting the values of the parameters passed. Any parameters not provided will be left unchanged.
api: PATCH /api/v1/workspaces/{workspace_slug}/initiatives/{initiative_id}/
---
