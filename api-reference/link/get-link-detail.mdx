...
description: Retrieves the details of an existing link by its ID.
api: GET /api/v1/workspaces/{workspace_slug}/projects/{project_id}/work-items/{work_item_id}/links/{link_id}
---
