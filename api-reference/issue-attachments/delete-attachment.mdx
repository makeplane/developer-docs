...
description: Permanently deletes an attachment from a work item. This action cannot be undone.
api: DELETE /api/v1/workspaces/{workspace_slug}/projects/{project_id}/work-items/{work_item_id}/attachments/{attachment_id}/
---
