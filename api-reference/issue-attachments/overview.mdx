...
Allows you to manage file attachments associated with work items and Intake issues. You can upload new attachments and retrieve existing attachments for a specific work item.

## APIs

```http
GET    /api/v1/workspaces/:workspace-slug/projects/:project_id/issues/:issue_id/issue-attachments/
GET    /api/v1/workspaces/:workspace-slug/projects/:project_id/issues/:issue_id/issue-attachments/:attachment_id/
POST   /api/v1/workspaces/:workspace-slug/projects/:project_id/issues/:issue_id/issue-attachments/
PATCH  /api/v1/workspaces/:workspace-slug/projects/:project_id/issues/:issue_id/issue-attachments/:attachment_id/
DELETE /api/v1/workspaces/:workspace-slug/projects/:project_id/issues/:issue_id/issue-attachments/:attachment_id/
```
