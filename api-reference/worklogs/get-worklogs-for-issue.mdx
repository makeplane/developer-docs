...
sidebarTitle: List all worklogs
description: Returns a list of all worklogs for a specific work item.
api: GET /api/v1/workspaces/{workspace_slug}/projects/{project_id}/work-items/{work_item_id}/worklogs/
---
