...
GET    /api/v1/workspaces/:workspace-slug/projects/:project_id/modules/archived/
POST   /api/v1/workspaces/:workspace-slug/projects/:project_id/modules/:module_id/archive/
POST   /api/v1/workspaces/:workspace-slug/projects/:project_id/modules/:module_id/unarchive/
