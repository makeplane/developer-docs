...
description: Permanently deletes a custom property from a work item type. This action cannot be undone.
api: DELETE /api/v1/workspaces/{workspace_slug}/projects/{project_id}/work-item-types/{type_id}/work-item-properties/{property_id}/
---
