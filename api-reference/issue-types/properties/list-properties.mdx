...
description: Returns a list of all custom properties for a work item type.
api: GET /api/v1/workspaces/{workspace_slug}/projects/{project_id}/work-item-types/{type_id}/work-item-properties/
---
