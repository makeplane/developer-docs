---
title: Add work item type
description: Creates a new work item type in your project
api: POST /api/v1/workspaces/{workspace-slug}/projects/{project_id}/work-item-types/
---
