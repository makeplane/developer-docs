---
title: Overview
description: Provides a comprehensive suite of endpoints for adding, modifying, and deleting work item types within your project.
---

## APIs

```http
POST   /api/v1/workspaces/:workspace-slug/projects/:project_id/work-item-types/
GET    /api/v1/workspaces/:workspace-slug/projects/:project_id/work-item-types/
GET    /api/v1/workspaces/:workspace-slug/projects/:project_id/work-item-types/:work_item_type_id/
PATCH  /api/v1/workspaces/:workspace-slug/projects/:project_id/work-item-types/:work_item_type_id/
DELETE /api/v1/workspaces/:workspace-slug/projects/:project_id/work-item-types/:work_item_type_id/
```
