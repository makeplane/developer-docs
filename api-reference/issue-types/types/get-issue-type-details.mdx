...
description: Retrieves the details of an existing work item type by its ID.
api: GET /api/v1/workspaces/{workspace_slug}/projects/{project_id}/work-item-types/{type_id}/
---
