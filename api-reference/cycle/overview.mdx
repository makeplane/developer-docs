...
GET    /api/v1/workspaces/:workspace-slug/projects/:project_id/archived-cycles/
POST   /api/v1/workspaces/:workspace-slug/projects/:project_id/archived-cycles/:cycle_id/archive/
DELETE /api/v1/workspaces/:workspace-slug/projects/:project_id/archived-cycles/:cycle_id/unarchive/
