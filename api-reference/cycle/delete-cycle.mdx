...
description: Permanently deletes a cycle from a project. This action cannot be undone.
api: DELETE /api/v1/workspaces/{workspace_slug}/projects/{project_id}/cycles/{cycle_id}/
---
