...
Inside a work item, you can add as many details as you like to get your work done.
...
GET    /api/v1/workspaces/:workspace-slug/issues/:identifier/
GET    /api/v1/workspaces/:workspace-slug/issues/search/
```
